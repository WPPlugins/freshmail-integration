...
function FreshMail_refreshReports() {
	jQuery.post(static_var.ajax, {'action': 'freshmail_get_reports', 'params': jQuery('#reports_form').serialize() }, function(response) {
...
function get_freshmail_fields(list_hash) {
	...
	jQuery.post(static_var.ajax, {'action': 'get_freshmail_fields', 'list_hash': list_hash }, function(response) {
...
function freshmail_saveAsCustomTheme() {
	...
	jQuery.post(static_var.ajax+"?form_id="+jQuery('#fm_form').attr('form_id'), {'action': 'freshmail_save_as_custom_theme', 'fm_form': jQuery('#fm_form').serialize() }, function(response) {
		var val;
...
function freshmail_changeTheme() {
	...
	jQuery('#preview_form').css('opacity', '0.3');
	jQuery('img#form_preview_loader').toggle();
	jQuery.post(static_var.ajax, {'action': 'freshmail_change_theme', 'theme_id': jQuery('#freshmail_select_theme').val() }, function(response) {
...
function freshmail_previewForm() {
	...
	jQuery('img#form_preview_loader').toggle();
	previewFormNow = true;
	jQuery.post(static_var.ajax, {'action': 'freshmail_preview_form', 'form_id': jQuery('#fm_form').attr('form_id'), 'form_serialize': jQuery('#fm_form').serialize() }, function(response) {
		jQuery('img#form_preview_loader').toggle();
